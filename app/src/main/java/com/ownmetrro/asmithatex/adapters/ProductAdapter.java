package com.ownmetrro.asmithatex.adapters;
...
import com.ownmetrro.asmithatex.databases.User_Recents_DB;
import com.ownmetrro.asmithatex.fragments.My_Cart;
import com.ownmetrro.asmithatex.fragments.Product_Description;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        if (position != productList.size()) {
            ...
            holder.product_thumbnail.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    String produ_id = String.valueOf(product.getProductsId());
                    ConstantValues.Products_id = produ_id;

                    ConstantValues.enquiry_status = product.getEnquiryStatus();
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(final View itemView) {
           ...
           // viewcount = itemView.findViewById(R.id.textView4);
