...
import com.ownmetrro.asmithatex.customs.DialogLoader;
import com.ownmetrro.asmithatex.models.device_model.AppSettingsDetails;
import com.ownmetrro.asmithatex.models.product_model.GetAllProducts;
import com.ownmetrro.asmithatex.models.product_model.Option;
import com.ownmetrro.asmithatex.models.product_model.Value;
import com.ownmetrro.asmithatex.models.product_model.ViewCountData;
import com.ownmetrro.asmithatex.network.APIClient;
import com.ownmetrro.asmithatex.utils.Utilities;
import com.ownmetrro.asmithatex.activities.Login;
import com.ownmetrro.asmithatex.adapters.ProductAttributesAdapter;
import com.ownmetrro.asmithatex.constant.ConstantValues;
import com.ownmetrro.asmithatex.models.cart_model.CartProduct;
import com.ownmetrro.asmithatex.models.cart_model.CartProductAttributes;
import com.ownmetrro.asmithatex.models.product_model.Attribute;
import com.ownmetrro.asmithatex.models.product_model.Image;
...
public class Product_Description extends Fragment {
    ...
    Button productCartBtn,productCancel;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Log.e("product id",ConstantValues.Products_id);
       ...
       product_id = ConstantValues.Products_id;
        Log.e("product id",ConstantValues.Products_id);


       /* if (productDetails.getContactPerson().equals(null) && productDetails.getContactCompany().equals(null)){
            floatingActionButton1.setVisibility(View.GONE);
        }*/


       product_likes.setVisibility(View.GONE);

       if (ConstantValues.enquiry_status.equals("0")){
        ...
        floatingActionButton1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                final View dialogView = inflater.inflate(R.layout.custom_call_popup, null);
                dialogBuilder.setView(dialogView);

                final TextView cl_office =  dialogView.findViewById(R.id.call_office);
                final TextView cl_sales =  dialogView.findViewById(R.id.call_sales);
                final TextView cl_saletxt = dialogView.findViewById(R.id.cl_sale);
                final TextView cl_off_txt = dialogView.findViewById(R.id.cl_off);

                if (productDetails.getContactPerson().equals("")){
                    cl_sales.setVisibility(View.GONE);
                    cl_saletxt.setVisibility(View.GONE);
                }
                if (productDetails.getContactCompany().equals(null)){
                    cl_office.setVisibility(View.GONE);
                    cl_off_txt.setVisibility(View.GONE);
                    cl_office.setText("None");
                    cl_sales.setText("None");

                }else {

                    cl_office.setText(productDetails.getContactCompany());
                    cl_sales.setText(productDetails.getContactPerson());
                }


                cl_sales.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Intent.ACTION_DIAL);
                        // Send phone number to intent as data
                        intent.setData(Uri.parse("tel:" + cl_sales.getText().toString()));
                ...
                cl_office.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Intent.ACTION_DIAL);
                        // Send phone number to intent as data
                        intent.setData(Uri.parse("tel:" + cl_office.getText().toString()));
                        // Start the dialer app activity with number
                        startActivity(intent);
                    }
                });
        ...
        floatingActionButton2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (ConstantValues.IS_USER_LOGGED_IN) {
                    ...
                    AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(getActivity());
                    LayoutInflater inflater = getActivity().getLayoutInflater();
                    final View dialogView = inflater.inflate(R.layout.custom_message_popup, null);
                    dialogBuilder.setView(dialogView);
              ...
              /*  final EditText name = (EditText) dialogView.findViewById(R.id.customName);
                final EditText email = (EditText) dialogView.findViewById(R.id.customEmail);*/
                    ...
                    dialogBuilder.setTitle("Enquiry");
                    dialogBuilder.setMessage("Please enter your enquiry.");
                    dialogBuilder.setPositiveButton("Send", new DialogInterface.OnClickListener() {
                      ...
                      /*  String nameStr = name.getText().toString().trim();
                        String emailStr = email.getText().toString();*/
                            ...
                            Call<ViewCountData> call = APIClient.getInstance()
                                    .viewmessages
                                            (
                                                    ConstantValues.Products_id,customerID,messageStr
                                            );

                            call.enqueue(new Callback<ViewCountData>() {
                                @Override
                                public void onResponse(Call<ViewCountData> call, Response<ViewCountData> response) {


                                    if (response.isSuccessful()) {

                                        Log.e("viewCount","success");
                                        Toast.makeText(getActivity(), "Thank you for contacting us... We will get back to you soon.", Toast.LENGTH_LONG).show();
                                    }
                                ...
                                @Override
                                public void onFailure(Call<ViewCountData> call, Throwable t) {
                                }
                            });
                        }
                    });
    ...
    private void setProductDetails(final ProductDetails productDetails) {
        ...
        product_share_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.e("pname",productDetails.getProductsName());
        //        Log.e("pname_url",productDetails.getProductsUrl());
