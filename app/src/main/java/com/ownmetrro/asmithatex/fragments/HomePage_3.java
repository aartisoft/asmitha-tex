...
import com.ownmetrro.asmithatex.models.banner_model.BannerDetails;
...
public class HomePage_3 extends Fragment implements BaseSliderView.OnSliderClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // Add Recent Product Fragment to specified FrameLayout
        Fragment recentProduct = new RecentProduct();
        recentProduct.setArguments(bundle);
        fragmentManager.beginTransaction().replace(R.id.recently_added_fragment, recentProduct).commit();
        ...
        Fragment categories = new Categories_2();
        categories.setArguments(bundle);
        fragmentManager.beginTransaction().replace(R.id.all_categories_fragment, categories).commit();

      /*  // Add Categories_3 Fragment to specified FrameLayout
        Fragment sub_one = new Home_sub_one();
        sub_one.setArguments(bundle);
        fragmentManager.beginTransaction().replace(R.id.sub_one_fragment, sub_one).commit();

        // Add Categories_3 Fragment to specified FrameLayout
        Fragment sub_two = new Home_sub_two();
        sub_two.setArguments(bundle);
        fragmentManager.beginTransaction().replace(R.id.sub_two_fragment, sub_two).commit();

        // Add Categories_3 Fragment to specified FrameLayout
        Fragment sub_three = new Home_sub_three();
        sub_three.setArguments(bundle);
        fragmentManager.beginTransaction().replace(R.id.sub_three_fragment, sub_three).commit();
*/
