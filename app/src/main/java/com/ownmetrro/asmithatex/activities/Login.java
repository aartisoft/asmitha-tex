...
public class Login extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    EditText user_email, user_password, user_ccode;
    TextView forgotPasswordText, signupText;
    Button loginBtn, facebookLoginBtn, googleLoginBtn, otpLoginBtn;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       /* mGoogleSignInOptions = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
        ...
        otpLoginBtn = findViewById(R.id.loginwithotp);
        ...
        user_email.setText(sharedPreferences.getString("userPhone", null));
        user_password.setText(sharedPreferences.getString("userPassword",null));
    ...
    private void processLogin() {
        ...
        call.enqueue(new Callback<UserData>() {
            ...
            public void onResponse(Call<UserData> call, Response<UserData> response) {
                ...
                Log.e("logresponse",new Gson().toJson(response.body()));
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getSuccess().equalsIgnoreCase("1") || response.body().getSuccess().equalsIgnoreCase("2"))
                    {
                        ...
                        editor.putString("userPhone",  user_email.getText().toString().trim());
    ...
    private boolean validateLogin() {
        if (!ValidateInputs.isValidPhoneNo(user_email.getText().toString().trim())) {
            user_email.setError(getString(R.string.invalid_contact));
            return false;
        }
